<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">HomeService Admin</div>
    </a>
    ...
    <!-- Nav Item - Login Pages Collapse Menu -->
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapseAkun" class="collapse" aria-labelledby="headingAkun" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pusat Akun:</h6>
                <a class="collapse-item" href="login.html">Tambah Akun Teknisi</a>
    ...
    <div class="sidebar-card d-none d-lg-flex">
        ...
        <p class="text-center mb-2"><strong>HomeService Admin</strong> packed with premium features and components!</p>
